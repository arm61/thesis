...
I have endevoured to include as much algorithmic and methodological detail within the text, and where relevant working Code Blocks written in Python, and including appropriate documentation strings in the NumPy format, have been included for clarity.
