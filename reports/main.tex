...
This work focuses on the use of different coarse-graining methodologies to assist in the analysis of scattering measurements from soft matter species, such as surfactant monolayers and micelles.
The term `coarse-graining' is used broadly in this work; it is used to describe the coarse-graining of a classical simulation potential model and the use of these to analyse reflectometry measurements.
It has also been used to describe a surfactant monolayer model that consists two layers, the surfactant heads and tails, constrained to respect the chemical bond between them.
Additionally, a severe coarse-graining methodology has been used to describe a surfactant molecule as just a position and direction in space, to help in the understanding of micellar structure from small angle scattering.
...
A chemically-consistent surfactant monolayer model was developed and applied to reflectometry measurements of a phosphoplipid monolayer at the interface between air and a deep eutectic solvent.
This model, which allowed the volume of the phosphoplipid head and tails to vary freely, allowed for a unique insight into the structure of the monolayer at the given interface.
In an effort to assess the utility of coarse-grained potential models in the analysis of neutron reflectometry three potential models of different particle grain size were used to model a phospholipid monolayer.
...
Furthermore, using the highest resolution potential model it was possible to describe improvements that may be made to the chemically-consistent model in the future.
The final coarse-graining method involved using a particle swarm optimisation method to improve the position and direction of surfactant molecules to reproduce data from an experimental small angle neutron scattering measurement of a micellar solution.
The aim was to develop a method to easily produce a starting structure, for later molecular dynamics simulation, of a realistic micelle purely from the experimental scattering.

Alongside the development and application of coarse-graining methodologies, the final chapter of this work describes the development of open-source software and teaching material for the introduction of molecular simulation to students, in particular those that are users of scattering mesurements.
It is believed by many users of scattering techniques that molecular simulation driven analysis would offer improved analysis, however, few have access to the skills or knowledge to understand these simulations themselves.
These open-educational resources aim to introduce students to simulation in its utility in scattering analysis, to enable a future where simulation driven analysis is performed accurately by all.
