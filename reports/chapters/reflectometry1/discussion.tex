...
It can be seen from comparing Table~\ref{tab:water} with Tables~\ref{tab:xrrref1}, \ref{tab:xrrref2}, \ref{tab:xrrref3}, and \ref{tab:xrrref4} that the volumes of the phospholipid tails are significantly lower in the current measurement than found previously, by other techniques.
...
The major difference between the two head groups of the lipid is that the PG is present as a sodium salt, whereas the PC is zwitterionic.
