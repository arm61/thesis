...
The final application of \texttt{pylj} is its use in teaching molecular dynamics or Monte Carlo methods.
...
It is clear that both of these algorithms are simple and clear to implement, allowing the focus of the laboratory exercise to be on the students' understanding of the methodology.
