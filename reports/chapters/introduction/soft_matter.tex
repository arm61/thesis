...
\begin{itemize}
  \item the lengths scales are intermediate between atomistic and macroscopic,\sidenote[][-2\baselineskip]{typically \SIrange{1e-8}{1e-5}{\meter}.}
...
This means that at low concentrations, where it is statistically unlikely for an agglomerate to form, there will be a higher concentration of surfactants at the air-water interface, and as the concentration is increased, assuming the system is above the Krafft temperature,\footnote{The lowest temperature at which agglomerates will form.} organised structures will begin to appear.

The structures can be formed from surfactant solutions are diverse; featuring micellar, hexagonal, cubic, and lamellar mesophases.
...
These represent interesting model systems of significant interest both technologically\sidecite<-3\baselineskip>{anton_reverse_2010,zagnoni_miniaturised_2012} and biologically.\sidecite<-2\baselineskip>{kataoka_block_2012,mohwald_phospholipid_1990,kewalramani_effects_2010}
