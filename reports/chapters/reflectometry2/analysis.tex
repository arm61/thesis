...
The values of the head and tail scattering lengths are given in Table~\ref{tab:trad}, while the SLD of the super and subphase were taken as \SI{0}{\per\angstrom\square} and \SI{6.35}{\per\angstrom\square} (for \ce{D2O}) and \SI{0}{\per\angstrom\square} (for ACMW) respectively.
