...
\begin{figure}[t]
    ...
    \caption{The experimental SANS data, from a solution of hydrogenated \ce{C_{10}TANO_3} in \ce{D2O} at a concentration of \SI{30}{\milli M}, to which the real \texttt{fitoog} run was attempting to fit.}
    \label{fig:expdata}
\end{figure}
%
