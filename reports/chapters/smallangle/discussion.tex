...
This agreement with the ``experimental data'' in the test case is a positive result, and the resulting cells shown in Figure~\ref{fig:fake_result} appear to show some agreement with the coordination cell from which the ``experimental'' data was found.
