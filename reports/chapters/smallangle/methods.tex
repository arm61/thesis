...
When \texttt{fitoog} reads in a molecular input file, a \texttt{differences} object is created, this stores the differential between the expanded particle description and the more severe coarse grained description that is used in the PSO.
