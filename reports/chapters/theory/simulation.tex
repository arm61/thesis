...
\label{sec:mcmc}
Markov chain Monte Carlo\sidenote[][-1\baselineskip]{Abbreviated to MCMC.} is a sampling methodology, derived from direct sampling Monte-Carlo.\sidecite<-1.5\baselineskip>{krauth_statistical_2006}
