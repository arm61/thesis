...
\end{itemize}
%
Thermostating involves controlling the kinetic energy of the particles\sidenote[][-6\baselineskip]{Using Equation~\ref{equ:ek}.} such that the simulation temperature is kept at a predefined value.
