...
This work will focus on the use of small angle scattering\footnote{Generally abbreviated to SAS; with SAXS indicating the use of X-rays and SANS neutrons} and reflectometry techniques.
