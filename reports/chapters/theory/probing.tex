...
\begin{marginfigure}
    ...
    \caption{A diagram of an undulator insertion device, such as that on I07 and I22, where $\lambda_P$ is the period length between opposing magnets, reprinted by permission of Springer Nature Customer Service Centre GmbH: Springer Nature from \cite{garcia-gutierrez_bases_2009}.}
    \label{fig:undulator}
\end{marginfigure}
%
%
\begin{table}[b]
    \centering
    \small
    \caption{A comparision of the photon brilliance from different light sources. Adapted, with permission of Oxford University Press\textsuperscript{\textcopyright}, from \cite{sivia_elementary_2011}.}
    \label{tab:sources}
    \begin{tabular}{l | c}
        \toprule
