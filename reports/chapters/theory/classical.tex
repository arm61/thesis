...
\begin{figure}
	...
	\begin{minipage}{0.86\textwidth}
		\lstinputlisting[caption={An example of some code that may be used to generate the Lennard-Jones energy for a given atomistic system, which accounts for the periodic boundary condition and the energy cut-off distance.},label={cb:lj},language=python]{code_blocks/lennardjones.py}
	\end{minipage}
\end{figure}
%
