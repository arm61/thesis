...
def lj_energy(coordinates, cell, cut_off, A, B):
    """
    Calculates the potential energy arising from the Lennard-Jones potential
    model from a series of atomistic particles.

    Parameters
    ----------
    coordinates: float, array-like (N, 3)
        An array of the x, y, and z coordinates for each of the N particles in
        the simulation.
    ...
    -------
    float, array-like
        An array of length N containing the energy of each particle in the
        simulation.
    """
